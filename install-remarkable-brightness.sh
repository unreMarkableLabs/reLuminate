...
wget_remote=http://toltec-dev.org/thirdparty/bin/wget-v1.21.1-1  # TODO this needs updated to an arm64 version of wget (https://github.com/rM-self-serve/webinterface-onboot/issues/6)
